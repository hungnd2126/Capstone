...
public class CallScreenActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView receiverName= (TextView) findViewById(R.id.CallerName);
        TextView txtReceiverName= (TextView) findViewById(R.id.callerName);
        receiverName.setText(getIntent().getStringExtra("receiverName"));
        txtReceiverName.setText(getIntent().getStringExtra("receiverName"));
        CircleImageView circleImageView= (CircleImageView)findViewById(R.id.layout_item_avartar);
        BindingUtils.setImageUrl(circleImageView, ApiEndPoint.BASE_URL+getIntent().getStringExtra("receiverAvatar"));
    ...
    private void updateUI() {
        ...
        Call call = getSinchServiceInterface().getCall(mCallId);
        if (call != null) {
            mCallState.setText(CommonUtils.changeText(call.getState().toString()));
